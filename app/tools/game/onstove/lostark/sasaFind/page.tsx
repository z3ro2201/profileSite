...
export const metadata: Metadata = {
  ...
  description: "로스트아크 인벤 서버 사건/사고 게시판에서 비매너 유저를 검색하세요. 캐릭터명으로 과거 사건 이력을 확인하고 반복 피해를 방지할 수 있습니다.",
  keywords: "로스트아크, 사사게, 인벤, 서버 사건사고, 비매너, 유저 검색, 캐릭터, Lost Ark",
  alternates: {
  ...
  openGraph: {
    type: "website",
    title: "로스트아크 사사게 검색기",
    description: "로스트아크 인벤 서버 사건/사고 게시판 비매너 유저 검색 도구",
...
const SasaFindPage = () => {
  const structuredData = {
    ...
    description: "로스트아크 인벤 서버 사건/사고 게시판 검색 도구 - 비매너 유저 이력 확인",
    operatingSystem: "Any",
    offers: {
      "@type": "Offer",
      price: "0",
        ...
        <div className="pt-32 pb-12">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 mt-4">인벤 서버 사건/사고 게시판에서 비매너 유저를 검색하고 반복 피해를 방지하세요</p>
            </div>
            ...
            <div className="mt-16 grid md:grid-cols-3 gap-6 max-w-3xl mx-auto">
              <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                ...
                <p className="text-sm text-gray-600">캐릭터명만 입력하면 인벤 서버 사건/사고 게시판의 모든 관련 글을 찾아드립니다</p>
              </div>
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                ...
                <p className="text-sm text-gray-600">파티 매칭 전 캐릭터명을 검색하여 비매너 이력을 미리 확인할 수 있습니다</p>
              </div>
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                ...
                <p className="text-sm text-gray-600">로아 유저들이 공유한 비매너 행위 이력을 확인하고 안전한 플레이 환경을 만듭니다</p>
              </div>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">검색 결과에서 해당 캐릭터의 비매너 행위 이력을 확인하고, 파티 참여 여부를 판단하세요. 글을 클릭하면 인벤 게시판에서 자세한 내용을 볼 수 있습니다.</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <details className="bg-white rounded-lg p-5 shadow-sm border border-gray-100 cursor-pointer">
                  ...
                  <p className="mt-3 text-sm text-gray-600 leading-relaxed">
                    사사게는 '서버 사건/사고 게시판'의 줄임말로, 로스트아크 인벤에 있는 게시판입니다. 게임 내에서 비매너 행위를 저지른 유저들을 게시하고, 다른 유저들이 반복적인 피해를 받지 않도록 정보를 공유하는 취지의 커뮤니티입니다. 대부분의 로아 유저들이 파티 매칭 전 확인하는 곳입니다.
                  </p>
                </details>
                ...
                <details className="bg-white rounded-lg p-5 shadow-sm border border-gray-100 cursor-pointer">
                  ...
                  <p className="mt-3 text-sm text-gray-600 leading-relaxed">
                    레이드나 던전 파티를 구할 때 캐릭터명을 검색하여 과거 비매너 행위 이력이 있는지 확인할 수 있습니다. 먹튀, 트롤링, 욕설, 강퇴 등의 이력을 미리 확인하여 피해를 방지할 수 있습니다. 또한 본인의 캐릭터명이 언급된 글이 있는지 확인할 때도 활용할 수 있습니다.
                  </p>
                </details>
              </div>
            </div>
