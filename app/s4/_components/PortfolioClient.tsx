...
import { TEAL, mono, serif, PORTFOLIO_ITEMS, FILTERS, type FilterKey, type DetailItem } from "../_lib/theme";
...
export default function PortfolioClient() {
  ...
  const filtered = PORTFOLIO_ITEMS.filter((p) => filter === "전체" || p.tags?.includes(filter));
