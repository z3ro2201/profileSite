...
async function main() {
  ...
  const projects: Array<{
  ...
  }> = [
    {
      ...
      year: 2008,
      title: "'08 동서울대 홈페이지",
      subtitle: "동서울대학교 공식 홈페이지 리뉴얼 프로젝트.",
      tags: ["PHP"],
      category: "웹",
      color: "#f0ede8",
      period: "2008",
      ...
      stack: [
        ...
        { label: "Frontend", items: ["HTML", "CSS", "jQuery"] },
      ],
      order: 0,
    },
    {
      ...
      year: 2009,
      title: "'09 동서울대 홈페이지",
      subtitle: "전년도 홈페이지 유지보수 및 기능 개선.",
      tags: ["PHP"],
      category: "웹",
      color: "#f0ede8",
      period: "2009",
    ...
    },
    {
      ...
      stack: [
        { label: "Backend", items: ["PHP", "MySQL"] },
        { label: "Frontend", items: ["Bootstrap", "jQuery"] },
      ],
      order: 4,
    },
    {
      ...
      stack: [
        { label: "Frontend", items: ["Vue.js", "Chart.js"] },
    ...
    },
    {
      ...
      year: 2022,
      title: "명제교육원 자기진단 v2",
      subtitle: "v1 리뉴얼 — UI/UX 전면 개선 및 기능 확장.",
      tags: ["Web"],
      category: "웹",
      color: "#f5f0ff",
      period: "2022",
    ...
    },
    {
      ...
      year: 2025,
      title: "RPBX (Asterisk)",
      subtitle: "Asterisk 기반 소규모 PBX 솔루션.",
      tags: ["Node.js"],
      category: "앱",
      color: "#fff0ee",
      period: "2025.01.",
      ...
      stack: [
        { label: "Backend", items: ["Node.js", "Asterisk", "AMI"] },
    ...
    },
    {
      ...
      stack: [
        { label: "Backend", items: ["Node.js"] },
        { label: "Frontend", items: ["React", "Electron"] },
      ],
      order: 9,
    },
    {
